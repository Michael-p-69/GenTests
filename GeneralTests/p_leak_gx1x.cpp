...
namespace GeneralTests{
    ...
    PinM leakGX1X::pin_redirect(const PinM& alias) const{
        return alias;
    }
    
    PinML leakGX1X::_get_aliased(const PinML& pins){
        PinML aliased = "";
...
//         }
    ...
    std::map<REN::UTILS::FlowSequence, std::map<PinM, FloatM>> leakGX1X::_delta_map; 
    



//#ifdef ENABLE_REN_GENRIC
TMFAMILY_CLASS(REN::GeneralTests::leakGX1X)
//#endif 
